        ...
        <>
            <body>
                ...
                <section className="Section2">
                    <ContentKaart header="Doneren" icoon={Donate_icoon} actie="DONEREN" paragraph="Steun Theater Laak om onze voorstellingen betaalbaar te houden voor iedereen!" link="/doneren" />
